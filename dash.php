...
<!-- 
Purpose:
Serves as the admin dashboard for managing the online exam system.

Key Functionalities:
Quiz Overview: Displays a list of quizzes with options to delete quizzes. -->

<!-- Ranking Management: Displays user rankings sorted by scores.
User Management: Lists all registered users with options to delete them.
Feedback Management:

Displays feedback.
Allows admin to open and delete specific feedback entries.
Quiz Creation:

Step 1: Input quiz details (title, questions, marks, etc.).
Step 2: Add questions to the quiz with multiple-choice options and correct answers. --> -->