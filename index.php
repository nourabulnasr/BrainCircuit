  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="font-family:'typo' ">Misr International University</h4></div></div>
		</p>
      </div>
...
<!-- 
Purpose:
The main landing page for the project. Provides user registration and login functionality.

Key Functionalities:

User Registration:
Collects details: name, gender, college, email, mobile number, and password.
Validates user input (client-side JavaScript).
Sends data to sign.php for backend processing
Login Modal:
Allows users to log in via a modal form, directing requests to login.php.
Header and Footer:
Displays navigation options and project branding
Integration:

Frontend:
Styled with Bootstrap for consistent UI design.
Includes JavaScript-based form validation.
Backend:
Sends registration and login data to respective PHP files for processing:
Registration: sign.php
Login: login.php -->