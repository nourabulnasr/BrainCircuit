...
<!-- 
Purpose:
Handles multiple actions, including:

Managing quizzes (add, remove, restart).
Adding questions to quizzes.
Updating quiz history.
Handling user and feedback deletion.
Key Functionalities:

Feedback Deletion: Deletes feedback based on a unique ID.
User Deletion: Removes a user and associated history and rank data
Quiz Management:
Add a quiz: Inserts quiz details into the database.
Remove a quiz: Deletes a quiz and its related questions, options, answers, and history.
Add questions: Adds questions with multiple-choice answers to a quiz.
Quiz Restart: Clears user history for a specific quiz and updates their ranking. -->